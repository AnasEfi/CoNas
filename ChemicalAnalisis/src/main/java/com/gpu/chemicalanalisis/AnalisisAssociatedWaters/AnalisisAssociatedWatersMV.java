...
public class AnalisisAssociatedWatersMV extends BaseViewModel {
    ...
    public AnalisisAssociatedWatersMV(){
        super();
    }
    public AnalisisAssociatedWatersMV(int id, String point_ot, String n_skv, String dat_sel_an, String pres_be, String plot, String fe,
